...
import (
	...
	_ "keshuigu/mygrpc/examples/features/customloadbalancer/client/customroundrobin" // To register custom_round_robin.
...
func main() {
	...
	// 接受字符串返回*serviceconfig.ParseResult的函数
	sc := mr.CC.ParseServiceConfig(json)
	// builder
